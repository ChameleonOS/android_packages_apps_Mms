...
/**
 * This fragment provides a list view of existing conversations.
 */
public class ConversationListFragment extends ListFragment implements DraftCache.OnDraftChangedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainLayout = inflater.inflate(R.layout.conversation_list_screen, container);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView.setEmptyView(mMainLayout.findViewById(R.id.empty));
